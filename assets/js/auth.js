...
$(document).ready(function () {
  ...
  function showRegister() {
    $loginSection.hide();
    $registerSection
      .addClass("login-register-wrap show")
  ...
  $(document).on("click", ".btn-toggle-pw", function () {
    ...
    $(this).attr(
      "aria-label",
      isPass ? "Ocultar contraseña" : "Mostrar contraseña",
    );
  });
  ...
  $("#loginForm").on("submit", function (e) {
    ...
    $.getJSON("./data/usuarios.json")
      ...
      .fail(function () {
        $btn.prop("disabled", false).html("Ingresar al sistema");
        showAuthAlert(
          "Error al cargar los datos. Abre el proyecto con un servidor local (Live Server).",
          "danger",
        );
      });
  });

  // Envío de data— Registro
  ...
  // Redirección si hay una sesión activa
